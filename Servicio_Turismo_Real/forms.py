...
from .models import ArticuloDepartamento, ImagenDepartamento, Departamento, Funcionario, Cargo
    ...
    class Meta:
        ...
        widgets = {
        	'dep_nombre': TextInput(
				attrs={
					'class': 'form-control',
					'placeholder': 'ingrese el nomnre del departamento'
				}
			),
...
class TestForm(Form):
    cargos = ModelChoiceField(queryset=Cargo.objects.all(), widget=Select(attrs={
        'class': 'form-control select2',
        'style': 'width: 100%'
    }))

    funcionarios = ModelChoiceField(queryset=Funcionario.objects.none(), widget=Select(attrs={
        'class': 'form-control select2',
        'style': 'width: 100%'
    }))
    ...
    search = ModelChoiceField(queryset=Funcionario.objects.none(), widget=Select(attrs={
        'class': 'form-control select2',
        'style': 'width: 100%'
    }))