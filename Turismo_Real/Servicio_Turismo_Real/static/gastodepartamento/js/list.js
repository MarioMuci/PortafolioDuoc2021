    ...
    tblDetaDepa = $('#data').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    var buttons = '<a href="/Turismo_Real/EliminarDetalleCostoDepartamento/' + row.id + '/" class="btn btn-danger btn-xs"><i class="fa-solid fa-trash"></i></a>';
                    ...
                    buttons += '<a href="/Turismo_Real/DetalleCostoDepartamentoPdf/' + row.id + '/" target="_blanK" class="btn btn-info btn-xs btn-flat"><i class="fas fa-file-pdf"></i></a>';
