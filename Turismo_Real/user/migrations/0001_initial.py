    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_contacto', models.IntegerField(blank=True, null=True, verbose_name='Telefono Contacto')),
            ...
            options={
                ...
                'db_table': 'usuario',
                'ordering': ['id'],
                'permissions': (('is_funcionario', 'Is Funcionario'), ('is_cliente', 'Is Cliente')),
            },
            managers=[
